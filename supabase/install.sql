-- =====================================================================
--  David Jackson & Son - enquiry pipeline and analytics
--  ONE-PASTE INSTALL. Every migration in order, newest last.
--
--  Generated from supabase/migrations. Do not edit this file; edit the
--  migration and regenerate, or the two will disagree and the one that
--  gets run is this one.
--
--  Files, in order:
...
--    20260913_0011_analytics_archive.sql
-- =====================================================================
